...
#    Updated: 2025/02/10 11:59:15 by nfordoxc         ###   Luxembourg.lu      #
#                                                                              #
# **************************************************************************** #
...
ARG0			=	"salut mon amis comment vas-tu ??"

ARG1			=	"premier mot " "deuxieme mot " "troisieme mot"

ARG2			=	"parle plus fort je suis sourd ..."

ARG3			=	Damnit " ! " "Sorry students, I thought this thing was off."
...
.PHONY : all $(NAME) optimize bonus deb deb_bonus tester tester_bonus clean fclean re cafe nico good
...
bonus:		$(OBJ_BONUS)
	$(CXX) $(CXXFLAGS) $(CXX_OPT) $(OBJ_BONUS) $(MYLIBS_BONUS) -o $(NAME_BONUS)
	@echo "$(CGREEN)The programm $(NAME_BONUS) successfully compilled"
...
ifeq ($(arg),ARG0)
	...
	$(DEB) $(DEB_OPT) ./$(NAME) $(ARG2)
else ifeq ($(arg),ARG3)
	$(DEB) $(DEB_OPT) ./$(NAME) $(ARG3)
else ifeq ($(arg),ARG4)
	$(DEB) $(DEB_OPT) ./$(NAME) $(ARG4)
else
